...
echo "==========================================="
echo "  Compiling Ursag Sysstartpage for Alpine...           "
echo "==========================================="
...
rm -f ursag-sysstartpage
cp target-alpine/release/ursag-sysstartpage .

echo "[+] Ursag Sysstartpage compiled successfully!"
