...
echo "==========================================="
echo "  Compiling Ubara Reboot Shutdown for Alpine...           "
echo "==========================================="
...
rm -f ubara-reboot-shutdown
cp target-alpine/release/ubara-reboot-shutdown .

echo "[+] Ubara Reboot Shutdown compiled successfully!"
