...
echo "==========================================="
echo "  Compiling Nexus Extensionsmanager for Alpine...           "
echo "==========================================="
...
rm -f nexus-extensionsmanager
cp target-alpine/release/nexus-extensionsmanager .

echo "[+] Nexus Extensionsmanager compiled successfully!"
