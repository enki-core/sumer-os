...
echo "==========================================="
echo "  Compiling Cipher Passwordmanager for Alpine...           "
echo "==========================================="
...
rm -f cipher-passwordmanager
cp target-alpine/release/cipher-passwordmanager .

echo "[+] Cipher Passwordmanager compiled successfully!"
