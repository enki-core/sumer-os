...
echo "==========================================="
echo "  Compiling Abzu Downloadmanager for Alpine...           "
echo "==========================================="
...
rm -f abzu-downloadmanager
cp target-alpine/release/abzu-downloadmanager .

echo "[+] Abzu Downloadmanager compiled successfully!"
