...
echo "==========================================="
echo "  Compiling Rimush Bluetoothmanager for Alpine...           "
echo "==========================================="
...
rm -f rimush-bluetoothmanager
cp target-alpine/release/rimush-bluetoothmanager .

echo "[+] Rimush Bluetoothmanager compiled successfully!"
