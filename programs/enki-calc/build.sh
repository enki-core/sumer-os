...
# سكريبت تجميع حاسبة إنكي لإنتاج باينري متوافق مع نظام Alpine Linux المصغر
cd "$(dirname "$0")"

echo "==========================================="
echo "  Compiling Enki Calc for Alpine...        "
echo "==========================================="
...
rm -f enki-calc
cp target-alpine/release/enki-calc .

echo "[+] Enki Calc compiled successfully!"
