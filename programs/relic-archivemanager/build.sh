...
echo "==========================================="
echo "  Compiling Relic Archivemanager for Alpine...           "
echo "==========================================="
...
rm -f relic-archivemanager
cp target-alpine/release/relic-archivemanager .

echo "[+] Relic Archivemanager compiled successfully!"
