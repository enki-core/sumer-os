...
echo "==========================================="
echo "  Compiling Dubbin Printmanager for Alpine...           "
echo "==========================================="
...
rm -f dubbin-printmanager
cp target-alpine/release/dubbin-printmanager .

echo "[+] Dubbin Printmanager compiled successfully!"
