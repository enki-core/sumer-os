...
echo "==========================================="
echo "  Compiling Shamash Taskmanager for Alpine...           "
echo "==========================================="
...
rm -f Shamash-taskmanager
cp target-alpine/release/Shamash-taskmanager .

echo "[+] Shamash Taskmanager compiled successfully!"
