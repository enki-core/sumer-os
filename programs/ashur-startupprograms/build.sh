...
echo "==========================================="
echo "  Compiling Ashur Startupprograms for Alpine...           "
echo "==========================================="
...
rm -f ashur-startupprograms
cp target-alpine/release/ashur-startupprograms .

echo "[+] Ashur Startupprograms compiled successfully!"
