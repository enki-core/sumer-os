...
echo "==========================================="
echo "  Compiling Itura Offlinemaps for Alpine...           "
echo "==========================================="
...
rm -f itura-offlinemaps
cp target-alpine/release/itura-offlinemaps .

echo "[+] Itura Offlinemaps compiled successfully!"
