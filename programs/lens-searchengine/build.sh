...
echo "==========================================="
echo "  Compiling Lens Searchengine for Alpine...           "
echo "==========================================="
...
rm -f lens-searchengine
cp target-alpine/release/lens-searchengine .

echo "[+] Lens Searchengine compiled successfully!"
