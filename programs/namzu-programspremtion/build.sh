...
echo "==========================================="
echo "  Compiling Namzu Programspremtion for Alpine...           "
echo "==========================================="
...
rm -f namzu-programspremtion
cp target-alpine/release/namzu-programspremtion .

echo "[+] Namzu Programspremtion compiled successfully!"
