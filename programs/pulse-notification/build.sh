...
echo "==========================================="
echo "  Compiling Pulse Notification for Alpine...           "
echo "==========================================="
...
rm -f pulse-notification
cp target-alpine/release/pulse-notification .

echo "[+] Pulse Notification compiled successfully!"
