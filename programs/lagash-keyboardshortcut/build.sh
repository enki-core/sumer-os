...
echo "==========================================="
echo "  Compiling Lagash Keyboardshortcut for Alpine...           "
echo "==========================================="
...
rm -f lagash-keyboardshortcut
cp target-alpine/release/lagash-keyboardshortcut .

echo "[+] Lagash Keyboardshortcut compiled successfully!"
